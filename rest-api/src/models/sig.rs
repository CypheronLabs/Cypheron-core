...
pub enum SigVariant {
    ...
    #[deprecated(
        since = "0.2.0",
        note = "Use SlhDsaHaraka192f instead for NIST FIPS 205 compliance"
    )]
    Haraka192f,
    #[deprecated(
        since = "0.2.0",
        note = "Use SlhDsaSha2256s instead for NIST FIPS 205 compliance"
    )]
    Sha2_256s,
    #[deprecated(
        since = "0.2.0",
        note = "Use SlhDsaShake128f instead for NIST FIPS 205 compliance"
    )]
    Shake128f,
}
