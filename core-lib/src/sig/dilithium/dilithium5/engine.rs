...
impl SignatureEngine for Dilithium5Engine {
    ...
    fn keypair() -> Result<(Self::PublicKey, Self::SecretKey), Self::Error> {
        ...
        validate_ffi_dilithium_buffer!(&pk, ML_DSA_87_PUBLIC);
        validate_ffi_dilithium_buffer!(&sk, ML_DSA_87_SECRET);
    ...
    fn sign(msg: &[u8], sk: &Self::SecretKey) -> Result<Self::Signature, Self::Error> {
        ...
        validate_ffi_dilithium_buffer!(sk_bytes, ML_DSA_87_SECRET);
        validate_ffi_dilithium_buffer!(&sig_buffer, ML_DSA_87_SIGNATURE);
        ...
        match result {
            0 => {
                validate_dilithium_signature_output!(sig_buffer, siglen, ML_DSA_87_SIGNATURE);
