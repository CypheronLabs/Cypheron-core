...
#[deprecated(
    since = "0.2.0",
    note = "Use MlDsa44 instead for NIST FIPS 204 compliance"
)]
pub use dilithium::dilithium2::Dilithium2;
#[deprecated(
    since = "0.2.0",
    note = "Use MlDsa65 instead for NIST FIPS 204 compliance"
)]
pub use dilithium::dilithium3::Dilithium3;
#[deprecated(
    since = "0.2.0",
    note = "Use MlDsa87 instead for NIST FIPS 204 compliance"
)]
