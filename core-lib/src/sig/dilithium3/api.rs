...
impl DilithiumEngine for Dilithium3 {
    const PUBLIC_KEY_BYTES: usize = pqcrystals_dilithium3_ref_PUBLICKEYBYTES;
    const SECRET_KEY_BYTES: usize = pqcrystals_dilithium3_ref_SECRETKEYBYTES;
    const SIGNATURE_BYTES: usize = pqcrystals_dilithium3_ref_BYTES;
    ...
    unsafe fn ffi_sign(
        ...
        pqcrystals_dilithium3_ref_sign(sig, siglen, msg, msglen, sk)
    }
    ...
    unsafe fn ffi_verify(
        ...
        pqcrystals_dilithium3_ref_verify(sig, siglen, msg, msglen, pk)
    }
}
